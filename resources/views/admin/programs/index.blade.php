							...
							<tbody>
								...
								<tr>
									...
									@if($current_program->with_gender && $current_program->with_trans)
										@foreach($header_indicator as $indicator)
										<td data-male-{{$indicator}}="0"></td>
										<td data-female-{{$indicator}}="0"></td>
										<td data-trans-{{$indicator}}="0"></td>
										@endforeach
										<td data-male-total="0"></td>
										<td data-female-total="0"></td>
										<td data-trans-total="0"></td>
									@endif
								</tr>
								@endforeach
							</tbody>
