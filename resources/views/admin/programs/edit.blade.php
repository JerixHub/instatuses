        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header card-header-rose card-header-icon">
                    ...
                    <h4 class="card-title">Editing {{$current_program->name}}</h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('programs.update', $current_program->id) }}" class="form-horizontal">
                        @csrf
                        @method('patch')
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group bmd-form-group">
                                    <input type="text" class="form-control" name="name" value="{{$current_program->name}}">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group bmd-form-group">
                                    <select class="form-control" data-style="btn btn-link" name="barangay">
                                        ...
                                        @if($current_program->barangay->id == $barangay->id)
                            ...
                            <div class="col-sm-10 checkbox-radios">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" name="header_type" value="date" @if($current_program->header_type == 'date') checked @endif > Date
                                        <span class="circle">
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" name="header_type" value="age_monthly" @if($current_program->header_type == 'age_monthly') checked @endif> Age By Month
                                        <span class="circle">
                                            <span class="check"></span>
                                        </span>
                                    </label>
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" name="header_type" value="age_yearly" @if($current_program->header_type == 'age_yearly') checked @endif> Age by Year
                                        <span class="circle">
                                            <span class="check"></span>
                                        </span>
                                    </label>
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" name="header_type" value="quarterly" @if($current_program->header_type == 'quarterly') checked @endif> Quarterly
                                        <span class="circle">
                                            <span class="check"></span>
                                        </span>
                                    </label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10 checkbox-radios">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="checkbox" name="with_gender" @if($current_program->with_gender) checked @endif> With Gender
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="checkbox" name="with_trans" @if($current_program->with_trans) checked @endif> With Transgender
                                        <span class="form-check-sign">
                                            <span class="check"></span>
                                        </span>
                                    </label>
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="checkbox" name="with_target" @if($current_program->with_target) checked @endif> With Target
                                        <span class="form-check-sign">
                                            <span class="check"></span>
                                        </span>
                                    </label>
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="checkbox" name="with_total" @if($current_program->with_total) checked @endif> With Total
                                        <span class="form-check-sign">
                                            <span class="check"></span>
                                        </span>
                                    </label>
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="checkbox" name="with_icd_code" @if($current_program->with_icd_code) checked @endif> With ICD CODE
                                        <span class="form-check-sign">
                                            <span class="check"></span>
                                        </span>
                                    </label>
